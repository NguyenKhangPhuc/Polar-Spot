    ...
    >
      ...
      {eventId && (
        <Link
          ...
          className="px-4 py-2 bg-[#3be1fe] hover:bg-[#6ee7fc] text-black font-bold text-xs uppercase tracking-wider rounded-md transition-colors cursor-pointer flex items-center gap-1.5 shadow-md"
        >
