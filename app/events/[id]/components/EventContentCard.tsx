...
export function EventContentCard({ event }: EventContentCardProps) {
  ...
  return (
    ...
    >
      <div className="bg-[#0a0a0a] border border-white/12 rounded-md p-6 sm:p-8 shadow-xl space-y-8">
        {/* Short Description Section */}
        {event.short_description && (
          <div className="space-y-2 border-b border-white/12 pb-6">
            <h3 className="text-xs font-bold text-[#3be1fe] uppercase tracking-wider">
