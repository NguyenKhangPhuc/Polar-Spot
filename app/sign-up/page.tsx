        ...
        >
          ...
          <div className="flex items-center justify-between text-xs font-mono">
            <label className="flex items-center gap-2 text-slate-300 cursor-pointer select-none">
              <input
                type="checkbox"
                className="h-4 w-4 cursor-pointer accent-[#3be1fe] bg-[#050505] border border-white/18 rounded-md"
              />
          ...
          <div className="flex flex-col">
            <div className="flex items-start space-x-2.5">
              <input
                type="checkbox"
                id="isTermAccepted"
                className="mt-0.5 h-4 w-4 cursor-pointer accent-[#3be1fe] bg-[#050505] border border-white/18 rounded-md shrink-0"
