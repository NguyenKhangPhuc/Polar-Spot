        ...
        <div className="fixed inset-0 z-[9999] w-full h-screen flex justify-center items-center screen-bg backdrop-blur-md">
            <div className="flex flex-col items-center justify-center gap-6 select-none font-mono">
                ...
                <div className="relative flex items-center justify-center w-20 h-20">
                    ...
                    <div className="absolute inset-0 rounded-full border border-[#00e0b3]/20 animate-ping" />

                    {/* Rotating outer dash ring */}
                    <div className="absolute inset-0 rounded-full border-2 border-transparent border-t-[#00e0b3] border-r-[#00e0b3]/30 animate-spin shadow-[0_0_24px_rgba(0,224,179,0.25)]" />

                    {/* Counter-rotating inner ring */}
                    <div className="absolute inset-3 rounded-full border-2 border-transparent border-b-[#00e0b3]/70 border-l-[#00e0b3]/20 animate-spin [animation-direction:reverse] [animation-duration:1.5s]" />

                    {/* Center glowing obsidian core */}
                    <div className="relative w-4 h-4 rounded-sm bg-[#00e0b3] shadow-[0_0_12px_#00e0b3] flex items-center justify-center">
