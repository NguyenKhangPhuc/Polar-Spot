      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="flex flex-col items-center text-center space-y-2">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Polar Bear Pitching <span className="text-[#3be1fe]">Organizers</span>
          </h2>
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {organizers.map((org) => (
            <div
              key={org.id}
              className="bg-[#121212] rounded-md p-6 border border-white/12 hover:border-[#3be1fe]/50 transition-all duration-300 flex flex-col items-center text-center w-full sm:w-[340px] lg:w-[350px] shrink-0 group shadow-xl"
            >
              {/* Clean 1-Layer Image Container */}
              <div className="relative w-48 h-48 sm:w-56 sm:h-56 rounded-md bg-[#050505] border border-white/15 mb-6 group-hover:scale-105 group-hover:border-[#3be1fe]/50 transition-all duration-300 shadow-xl overflow-hidden shrink-0">
                <Image
                  src={org.image}
                  alt={org.name}
                  fill
              ...
              <div className="space-y-2 w-full flex flex-col items-center">
                <h3 className="text-xl sm:text-2xl font-bold text-white group-hover:text-[#3be1fe] transition-colors">
                  {org.name}
                </h3>

                <a
                  href={`mailto:${org.email}`}
                  className="inline-flex items-center gap-1.5 text-sm text-[#3be1fe] hover:text-white hover:underline transition-colors font-medium break-all"
                >
