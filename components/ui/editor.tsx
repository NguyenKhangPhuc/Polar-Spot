...
const editorVariants = cva(
  cn(
    ...
    'rounded-md ring-offset-background focus-visible:outline-none caret-[#00ffec]',
    '**:data-slate-placeholder:pointer-events-none **:data-slate-placeholder:text-[#83958d] **:data-slate-placeholder:opacity-75',
    '[&_strong]:font-bold'
  ),
  {
    defaultVariants: {
    ...
    variants: {
      ...
      variant: {
        ...
        default:
          'size-full p-4 text-sm text-[#e8e1df] min-h-[220px] focus:outline-none',
